...
public class executeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("edit_id") != null) {
           request.setAttribute("blog", blogsDAO.findBlogById(Integer.parseInt(request.getParameter("edit_id"))));
           request.getRequestDispatcher("edit_blog.jsp").forward(request, response);
        } else if (request.getParameter("delete_id") != null) {
            blogsDAO.deleteBlog(Integer.parseInt(request.getParameter("delete_id")));
